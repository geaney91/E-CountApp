...
{
    quota = 8080;//(valids.size()/(seats+1))+1;//2680
...
int STV::more_than_one_surplus(QList<Candidate *> candidates_with_surpluses, Candidate *c, QVector<int> &next_preferences)
{
    ...
    {
        equal_surpluses(candidates_with_surpluses);
    }
    else
    {
